...
import com.fatec.scel.services.LivroServices;

@RestController
@RequestMapping(value="/api")
public class LivroController {
	// insert into livro values ('1111', 'Pressman', 'Engenharia de Software');
	// insert into livro values ('2222', 'Sommerville', 'Engenharia de Software');
	// insert into livro values ('3333', 'Delamaro', 'Introdução ao Teste de Software')
	@Autowired
